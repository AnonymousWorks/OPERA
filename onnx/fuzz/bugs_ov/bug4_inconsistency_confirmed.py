...
input_x = np.random.randint(0, 2, size=[6], dtype=np.int64)
input_y = np.random.randint(0, 2, size=[6], dtype=np.int64)
...
# [confirmed] https://github.com/openvinotoolkit/openvino/issues/20898
