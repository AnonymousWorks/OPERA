...
def run_subprocess(python_program):
    ...
    if run_flag.returncode == 0:  # run well
        output = run_flag.stdout.decode('utf-8', errors='replace')
        output_final = ''
...
if __name__ == '__main__':
    # cd keras/fuzz
    # python run_fuzz_common.py ../data/demo.py openvino keras
    # python run_fuzz_common.py ../data/combined_sources_keras_test_41986.py tvm pytorch
